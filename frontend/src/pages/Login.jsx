    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      ...
      <div className="w-full max-w-md bg-white rounded-3xl shadow-xl border border-gray-100 p-8 sm:p-10">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input 
                ...
                value={email} onChange={e => setEmail(e.target.value)} type="email" required placeholder="name@company.com"
              />
            </div>
          </div>
        ...
        <div className="mt-8 text-center text-sm text-gray-500">
          Don't have an account? <span className="text-black font-semibold cursor-pointer hover:underline">Contact Admin</span>
        </div>
      </div>
    </div>
  );
