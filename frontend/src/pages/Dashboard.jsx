...
function RecordSaleModal({
  ...
  async function createSale(e) {
    ...
    if (!Number.isFinite(amt) || amt <= 0)
      return setSaleError("Invalid amount");
        ...
        {showAddCustomer && (
          <div className="p-4 bg-blue-50/50 border border-blue-100 rounded-xl space-y-3 animate-in fade-in slide-in-from-top-2">
            ...
            <button
              ...
              className="w-full py-1.5 bg-blue-600 text-white rounded-lg text-sm font-medium shadow-sm hover:bg-blue-700"
            >
...
export default function Dashboard() {
  ...
  const handleExport = async () => {
    setExporting(true);
    try {
      const res = await api.get(`/sales/export?range=${range}`, {
        responseType: "blob",
      });
        ...
        <div className="max-w-6xl mx-auto space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                {(summary?.payments || []).map((p) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-xs px-2 py-1 bg-white rounded border text-gray-500">
                        {p.count} orders
                      </span>
                    </div>
            ...
            <div className="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="space-y-4">
                  {(summary?.recent_sales || []).length === 0 ? (
                    ...
                    (summary?.recent_sales || []).map((sale) => (
                      <div
                        key={sale.id}
                        className="flex items-center justify-between p-4 bg-gray-50 rounded-xl border border-gray-100 hover:bg-white hover:shadow-sm transition-all"
                      >
              ...
              {/* Right: Top Customers (Already in your code, just positioned here) */}
